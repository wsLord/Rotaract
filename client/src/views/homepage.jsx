                ...
                >
                  <div className="navbar-nav ml-auto align-items-center">
					...
					<div className="container-fluid s__b__s">
						<div className="row">
							<div className="col-md-6 d-flex justify-content-center">{titleHead}</div>
          ...
          <div className="container our__vision__section">
					...
					<div className="cards">
						<div className="card card-1">
							...
							<h2 className="card__desc">
								Rotaract Club of MNNIT is an international service organization under the Rotary
								International, for all who wish to create a difference in the society today.We were
								established on 28 May,2015 under the club sponsorship of Rotary Club of Allahabad
								Elite, Uttar Pradesh, India. From a humble 15 members team size we have grown to a
								60+ member team.
							</h2>
						</div>
						...
						<div className="card card-2">
							...
							<h2 className="card__desc">
								The motto of the club is service before self. We aim not only to serve society in
								any possible way but create a feeling of care, responsibility and duty among the
            ...
            <div>Loading...</div>
				...
				<div className="container">
					<Carousel>
						<Carousel.Item>
							<img className="d-block w-100" src={shareSectionImg} alt="First slide" />
							<Carousel.Caption>
								...
								>
									<Button variant="outline-secondary">Winter Cloth Donation Drive</Button>{" "}
								</Link>
							</Carousel.Caption>
						</Carousel.Item>
						<Carousel.Item>
							<img className="d-block w-100" src={shareSectionImg} alt="Second slide" />
						...
						<Carousel.Item>
							<img className="d-block w-100" src={shareSectionImg} alt="Third slide" />
						...
						<Carousel.Item>
							<img className="d-block w-100" src={shareSectionImg} alt="Fourth slide" />
							...
							<Carousel.Caption>
								...
								>
									<Button variant="outline-secondary">Leprosy Hospital Visit</Button>{" "}
								</Link>
							</Carousel.Caption>
						</Carousel.Item>
						<Carousel.Item>
							<img className="d-block w-100" src={shareSectionImg} alt="Fifth slide" />
						...
						<Carousel.Item>
							<img className="d-block w-100" src={shareSectionImg} alt="Sixth slide" />
							...
							<Carousel.Caption>
								...
								>
									<Button variant="outline-secondary">Blood Donation Drive</Button>{" "}
								</Link>
							</Carousel.Caption>
						</Carousel.Item>
						<Carousel.Item>
							<img className="d-block w-100" src={shareSectionImg} alt="Seventh slide" />
								...
								<div class="">
									<div class="">
										...
										<p class="small text-muted">
											We were established on 28 May,2015 under the club sponsorship of Rotary Club
											of Allahabad Elite, Uttar Pradesh, India. From a humble 15 members team size
											we have grown to a 60+ member team.
										</p>
										<div className="hr"></div>
										<h6>MNNIT Allahabad, Teliarganj, Prayagraj, Uttar Pradesh 211004</h6>
										<h6>
